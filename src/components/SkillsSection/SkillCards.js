    ...
    <LazyMotion features={domAnimation} strict>
      ...
      {skills.map((skill, index) => (
        <m.div
          ...
          key={index}
          className="card w-[300px] h-[300px] flex flex-col items-center  bg-white rounded-xl border-4 border-primary-600 cursor-pointer"
        >
          <div className="w-full h-[60px] flex items-center gap-2 p-1 flex-col">
            ...
            <span
              className="text-center bg-white text-grayscale-950 rounded-xl text-base p-4"
              style={{
                fontFamily: "Poppins, sans-serif",
                fontWeight: "400",
              }}
